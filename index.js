/**
 * City_MD v1.0 — Multi-User WhatsApp Bot
 * Built by Scotty | Owner: 263788114185
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(chalk.cyan(`║  🤖  City_MD v2.0 Multi-User Bot    ║`));
